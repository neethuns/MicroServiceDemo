package com.maveric.customer.demo.aop;
...
public class CustomerAspect {
    ...
    @Before(value="execution(* com.maveric.customer.demo.controller.*.*(..))")
    public void logStatementBefore(JoinPoint joinPoint) {
        log.info("Executing controller {}", joinPoint);
    }
    @Before(value="execution(* com.maveric.customer.demo.service.*.*(..))")
    public void logStatementBeforeService(JoinPoint joinpoint){
        log.info("Executing Service {}",joinpoint);
    }

    @After(value = "execution(* com.maveric.customer.demo.controller.*.*(..))")
    public void logStatementAfter(JoinPoint joinPoint) {
        log.info("Complete execution of controller {}", joinPoint);
    }
    @AfterReturning(value = "execution(* com.maveric.customer.demo.controller.*.*(..))",returning = "result")
    public void logStatementAfterReturning(JoinPoint joinpoint,Object result) {
       ...
       @After(value="execution(* com.maveric.customer.demo.service.*.*(..))")
    public void logStatementAfterService(JoinPoint joinpoint)
    {
        log.info("Complete execution of  Service {}",joinpoint);
    }
    @Around(value = "execution(* com.maveric.customer.demo.service.*.*(..))")
    ...
    @Around(value = "execution(* com.maveric.customer.demo.controller.*.*(..))")
